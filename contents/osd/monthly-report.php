...
//for getting Student information Sheet number of student
  ...
  $sql="SELECT * FROM student_offenses WHERE type_of_violation='Minor' && month='$graph_month' && year='$graph_year' ORDER BY id ASC";
...
//for getting Student information Sheet number of student
  ...
  $sql1="SELECT * FROM student_offenses WHERE type_of_violation='Major' && month='$graph_month' && year='$graph_year' ORDER BY id ASC";
