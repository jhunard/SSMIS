                 ...
                 <ul class="nav navbar-nav">
                  ...
                  <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-plus-circle"></i><a href="">Add Program</a></li>
                        </ul>
                    </li>
                              ...
                              <div class="card-header bg-dark">
                                ...
                                <ul class="list-group list-group-flush">
                                       ...
                                       <div style="margin-top:20px; margin-bottom:20px;" class="text-center"> 
                                          ...
                                          <button type="button" data-toggle="modal" data-target="#services" type="button" class="btn btn-sm btn-success " style="padding:10px;">Add Services</button>
