                                ...
                                <div class="row form-group">
                                       ...
                                       <div class="row form-group">
                                        <div class="col-12 col-md-3"><label for="retypepass" class=" form-control-label">Retype Password:</label></div>
                                          <div class="col-12 col-md-4"><input type="password" name="re-type" class="form-control" placeholder="Retype Password" required></div>
                                        </div><br>

                                         <div class="row form-group">
                                            <div class="col-12 col-md-3"><label for="department" class=" form-control-label">Department:</label></div>
                                             <div class="col-12 col-md-4"><select id="department" name="department" class="form-control " required>
...
?>                                          </select>
                                            ...
                                            <div class="row form-group">
                                               ...
                                               <div class="col-12 col-md-6"><select id="program" name="program" class="form-control" required>
                                                                                          
<?php
 
 include '../connections/conn.php';

         $sql2 = "SELECT * FROM program ORDER BY id ASC";
         $result2 = $conn->query($sql2);
   
             if ($result2->num_rows > 0) {
                 // output data of each row
                 while($row2 = $result2->fetch_assoc()) {
                    echo "<option value='".$row2["program"]."'>".$row2["program"]."</option>";
                   }
                 } else {
                     echo "0 results";
                 }
