                    ...
                    <div class="col-md-6 offset-md-3" style="margin-top:50px;">
                            ...
                            <section class="card">
                              <div class="card-header bg-dark">
                                <strong class="card-title text-warning">Offense Type</strong>
                              </div>
                                ...
                                <ul class="list-group list-group-flush">
                                          ...
                                          $sql = "SELECT * FROM offense WHERE 1";
                                          $result = $conn->query($sql);
                                       ...
                                       <div style="margin-top:20px; margin-bottom:20px;" class="text-center"> 
                                          ...
                                          <button type="button" data-toggle="modal" data-target="#services" type="button" class="btn btn-sm btn-success " style="padding:10px;">Add Offense Type</button>

                                          <button type="button"button type="button" class="btn btn-sm btn-primary " style="padding:10px;" data-toggle="modal" data-target="#enable" >Enable Offense Type</button>

                                          <button type="button" class="btn btn-sm btn-dark " style="padding:10px;" data-toggle="modal" data-target="#disable" >Disable Offense Type</button>
                                          <button type="button" data-toggle="modal" data-target="#delete" class="btn btn-sm btn-danger " style="padding:10px;">Delete Offense Type</button>
  ...
  <div class="modal-dialog" style="position: absolute;top:5%;right:0;bottom:0;left:0;">
    <div class="modal-content">
      ...
      <div class="modal-header" style="background-color:#343a40!important; color:#ffc107!important;">
        <h4 class="col-11 modal-title text-center">All Offense Type</h4>
      </div>
           <!-- Modal body -->
      ...
      include '../connections/conn.php';
            ...
            $sql = "SELECT * FROM offense WHERE status = '0'";
            $result = $conn->query($sql);
...
?>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#add-services" data-dismiss="modal">Add Offense Type</button>
...
<div class="modal fade modal "tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true" id="enable">
  ...
  <form  action="../connections/enable.php" method="POST" enctype="multipart/form-data">
      <!-- Modal Header -->
      <div class="modal-header" style="background-color:#343a40!important; color:#ffc107!important;">
        <h4 class="col-11 modal-title text-center">List of Disabled Offense Type</h4>
      </div>
      ...
      include '../connections/conn.php';
            ...
            $sql = "SELECT * FROM offense WHERE status = '1'";
            $result = $conn->query($sql);
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        $count += 1;
                        echo "<input type='radio' name='disable' value='".$row["offense"]."'>&nbsp;".$row["offense"]."<br>";
                      }
                    } else {
                        echo "0 results";
                    }
...
?>
      ...
      <!-- Modal footer -->
      <div class="modal-footer">
       <button type="submit" name="submit" class="btn btn-sm btn-primary " style="padding:10px;">Enable Offense Type</button>
...
<div class="modal fade modal "tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true" id="disable">
  ...
  <form  action="../connections/disable.php" method="POST" enctype="multipart/form-data">
      <!-- Modal Header -->
      <div class="modal-header" style="background-color:#343a40!important; color:#ffc107!important;">
        <h4 class="col-11 modal-title text-center">List of Enabled Offense Type</h4>
      </div>
...
?>
      ...
      <!-- Modal footer -->
      <div class="modal-footer">
       <button type="submit" name="submit" class="btn btn-sm btn-dark "  style="padding:10px;">Disable Offense Type</button>
        <button type="button" class="btn btn-danger" data-dismiss="modal"  style="padding:10px;">Cancel</button>
      </div>
  </form>
    </div>
...
<div class="modal fade modal "tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true" id="add-services">
  <div class="modal-dialog modal-dialog-centered" role="dialog" style="position: absolute;top:-20%;right:0;bottom: 0;left:5%;">
    <div class="modal-content" >
      ...
      <!-- Modal Header -->
      <div class="modal-header" style="background-color:#343a40!important; color:#ffc107!important;">
        <h4 class="col-11 modal-title text-center">Add Offense Type</h4>
      ...
      <!-- Modal footer -->
      <div class="modal-footer">
        <button type="submit" class="btn btn-success"  style="padding:10px;" >Add Offense Type</button>
        <button type="button" class="btn btn-danger" data-dismiss="modal"  style="padding:10px;">Cancel</button>
      </div>
        </form>
    </div>
...
<div class="modal fade modal "tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true" id="delete">
  ...
  <form  action="../connections/delete.php" method="POST" enctype="multipart/form-data">
      <!-- Modal Header -->
      <div class="modal-header" style="background-color:#343a40!important; color:#ffc107!important;">
        <h4 class="col-11 modal-title text-center">List of Offense Type</h4>
      </div>
...
?>
      ...
      <!-- Modal footer -->
      <div class="modal-footer">
       <button type="submit" name="submit" class="btn btn-sm btn-warning"  style="padding:10px;">Delete Offense Type</button>
        <button type="button" class="btn btn-danger" data-dismiss="modal"  style="padding:10px;">Cancel</button>
      </div>
  </form>
    </div>
