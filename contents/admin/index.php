 ...
 <div class="col col-md-12">
                        <div class="card">
                            <div class="card-header text-center">
                                <strong class="card-title">List of Accounts</strong>
                            </div>
                            <div class="card-body" >
                                <table id="bootstrap-data-table" class="table table-striped table-bordered " width="100%">
                                <div class="float-right">
                                      <div class="" style="margin-right:20px">
                                       <a href="register.php"> <button  type="button" class="btn btn-sm btn-success">Add Account</button></a>
                                 ...
                                 <thead>
                                        <tr>
                                          <th >No.</th>
                                          <th style="font-size:14px; min-width:70px;">UserName</th>
                                          <th style="font-size:14px; min-width:70px;">Password</th>
                                          <th style="font-size:14px; min-width:70px;">Image</th>
                                          <th style="font-size:14px; min-width:70px;">Position</th>
                                           <th style="font-size:14px; min-width:70px;">Program</th>
                                           <th style="font-size:14px; min-width:70px;">Department</th>
                                            <th style="font-size:14px; min-width:70px;">Update</th>
                                      ...
                                      <?php
                                        include '../connections/conn.php';
                                              ...
                                              $sql = "SELECT * FROM user_info WHERE position != 'administrator' ORDER BY id DESC ";
                                              $result = $conn->query($sql);
                                                  ...
                                                  if ($result->num_rows > 0) {
                                                      ...
                                                      while($row = $result->fetch_assoc()) {
                                                        ...
                                                        $count += 1;
                                                          ...
                                                          <td><img src='../guidance/images/".$row["img"]."' width='50px' height='50px'></td>
                                                          <td>".$row["position"]."</td>
                                                          <td>".$row["program"]."</td>
                                                          <td>".$row["department"]."</td>
                                                          <td>  <a href='update-account.php?net=".$row["id"]."'> <button  type='button' class='btn btn-sm btn-success'>Update Account</button></a></td>
                                                        </tr>";
                                                        }
                                                      } else {
