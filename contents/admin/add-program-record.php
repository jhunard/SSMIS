                    ...
                    <div class="col-md-6 offset-md-3" style="margin-top:50px;">
                            ...
                            <section class="card">
                              <div class="card-header bg-dark">
                                <strong class="card-title text-warning">Program</strong>
                              </div>
                                ...
                                <ul class="list-group list-group-flush">
                                          ...
                                          $sql = "SELECT * FROM program WHERE status = '0'";
                                          $result = $conn->query($sql);
                                       ...
                                       <div style="margin-top:20px; margin-bottom:20px;" class="text-center"> 
                                          ...
                                          <button type="button" data-toggle="modal" data-target="#services" type="button" class="btn btn-sm btn-success " style="padding:10px;">Add Program</button>

                                          <button type="button"button type="button" class="btn btn-sm btn-primary " style="padding:10px;" data-toggle="modal" data-target="#enable" >Enable Program</button>

                                          <button type="button" class="btn btn-sm btn-dark " style="padding:10px;" data-toggle="modal" data-target="#disable" >Disable Program</button>
                                          <button type="button" data-toggle="modal" data-target="#delete" class="btn btn-sm btn-danger " style="padding:10px;">Delete Program</button>
  ...
  <div class="modal-dialog" style="position: absolute;top:5%;right:0;bottom:0;left:0;">
    <div class="modal-content">
      ...
      <div class="modal-header" style="background-color:#343a40!important; color:#ffc107!important;">
        <h4 class="col-11 modal-title text-center">All Program</h4>
      </div>
           <!-- Modal body -->
      ...
      include '../connections/conn.php';
            ...
            $sql = "SELECT * FROM program WHERE 1";
            $result = $conn->query($sql);
...
?>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#add-services" data-dismiss="modal">Add Program</button>
...
<div class="modal fade modal "tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true" id="enable">
  ...
  <form  action="../connections/enable.php" method="POST" enctype="multipart/form-data">
      <!-- Modal Header -->
      <div class="modal-header" style="background-color:#343a40!important; color:#ffc107!important;">
        <h4 class="col-11 modal-title text-center">List of Disabled Program</h4>
      </div>
            ...
            $result = $conn->query($sql);
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        $count += 1;
                        echo "<input type='radio' name='disable' value='".$row["program"]."'>&nbsp;".$row["program"]."<br>";
                      }
                    } else {
                        echo "0 results";
                    }
...
?>
      ...
      <!-- Modal footer -->
      <div class="modal-footer">
       <button type="submit" name="submit" class="btn btn-sm btn-primary " style="padding:10px;">Enable Program</button>
...
<div class="modal fade modal "tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true" id="disable">
  ...
  <form  action="../connections/disable.php" method="POST" enctype="multipart/form-data">
      <!-- Modal Header -->
      <div class="modal-header" style="background-color:#343a40!important; color:#ffc107!important;">
        <h4 class="col-11 modal-title text-center">List of Enabled Program</h4>
      </div>
      ...
      include '../connections/conn.php';
            ...
            $sql = "SELECT * FROM program WHERE status = '0' AND id != 1";
            $result = $conn->query($sql);
...
?>
      ...
      <!-- Modal footer -->
      <div class="modal-footer">
       <button type="submit" name="submit" class="btn btn-sm btn-dark "  style="padding:10px;">Disable Program</button>
        <button type="button" class="btn btn-danger" data-dismiss="modal"  style="padding:10px;">Cancel</button>
      </div>
  </form>
    </div>
...
<div class="modal fade modal "tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true" id="delete">
  ...
  <form  action="../connections/delete.php" method="POST" enctype="multipart/form-data">
      <!-- Modal Header -->
      <div class="modal-header" style="background-color:#343a40!important; color:#ffc107!important;">
        <h4 class="col-11 modal-title text-center">List of Program</h4>
      </div>
...
?>
      ...
      <!-- Modal footer -->
      <div class="modal-footer">
       <button type="submit" name="submit" class="btn btn-sm btn-warning"  style="padding:10px;">Delete Program</button>
        <button type="button" class="btn btn-danger" data-dismiss="modal"  style="padding:10px;">Cancel</button>
      </div>
  </form>
    </div>
