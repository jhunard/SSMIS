                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header text-center">
                                <strong class="card-title">List of Offense Type</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                               		 <div class="float-right">
                								       <div class="" style="margin-right:20px">
                								       <a href="settings-add-offense-type.php"> <button type="button" class="btn btn-sm btn-success" style="">Add</button></a>
                								       </div>   
                								   		 </div>
                                   <thead>
                                      <tr>
                                    ...
                                    <?php
                                      include '../connections/conn.php';
                                            ...
                                            $sql = "SELECT * FROM offense ORDER BY id DESC";
                                            $result = $conn->query($sql);
