...
//for getting Student information Sheet number of student
  ...
  $sql="SELECT * FROM graph_data WHERE services='Student Information Sheet' && quarter='$graph_month'  ORDER BY id ASC";
...
//for getting Student information Sheet number of student
  ...
  $sql1="SELECT * FROM graph_data WHERE services='Referral Counseling' && quarter='$graph_month'  ORDER BY id ASC";
...
//for getting Student information Sheet number of student
  ...
  $sql2="SELECT * FROM graph_data WHERE services='Request for Good Moral' && quarter='$graph_month'  ORDER BY id ASC";
...
//for getting Student information Sheet number of student
  ...
  $sql3="SELECT * FROM graph_data WHERE other_index = '1' && quarter='$graph_month'  ORDER BY id ASC";
