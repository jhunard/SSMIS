...
<div class="container">
   <div class="form-row text-center">
      <div class="col-12"><h1>Referal Counceling</h1></div>
   </div>
</div>
...
<style>
    .border-remove{
      ...
      Name : <input class='border-remove col-md-3' type="text" name="rcfName" value="<?php echo $fname;?>" readonly>
      <input class='border-remove  col-md-3' type="text" name="rcmName" value="<?php echo $mname;?>" readonly>
      <input class='border-remove  col-md-4' type="text" name="rclName" value="<?php echo $lname;?>" readonly>
      ID No : <input class='border-remove col-md-10' type="text" name="rcsrCode" value="<?php echo $db_srcode;?>" readonly>
      Year Level : <input class='border-remove col-md-10' type="text" name="rcyearlevel" value="<?php echo $yearlevel;?>" readonly>
      Program : <input class='border-remove  col-md-10' type="text" name="rcprogram" value="<?php echo $program;?>" readonly>
      Department : <input class='border-remove  col-md-8' type="text" name="rcdepartment" value="<?php echo $department;?>" readonly>
</div>
    <br><br><br>    
   <a style="font-size:18px;">Date: <input type="date" style='border:none;text-align:center;' name='rcdate' style="font-size:14px;" required></a><br>
    <a style="font-size:18px;">Reason: <input type="text"name='rcreason' style=" border:0;outline: 0;background: transparent; border-bottom: 1px solid black;" required></a>
