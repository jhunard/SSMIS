...
<div class="container">
   <div class="form-row text-center">
      <div class="col-12"><h1>Request for Good Moral</h1></div>
   </div>
</div>
...
<style>
    .border-remove{
      ...
      Name : <input class='border-remove col-md-3' type="text" name="rgmfName" value="<?php echo $fname;?>" readonly>
      <input class='border-remove  col-md-3' type="text" name="rgmmName" value="<?php echo $mname;?>" readonly>
      <input class='border-remove  col-md-4' type="text" name="rgmlName" value="<?php echo $lname;?>" readonly>
      ID No : <input class='border-remove col-md-10' type="text" name="rgmsrCode" value="<?php echo $db_srcode;?>" readonly>
      Year Level : <input class='border-remove col-md-10' type="text" name="rgmyearlevel" value="<?php echo $yearlevel;?>" readonly>
      Program : <input class='border-remove  col-md-10' type="text" name="rgmprogram" value="<?php echo $program;?>" readonly>
      Department : <input class='border-remove  col-md-8' type="text" name="rgmdepartment" value="<?php echo $department;?>" readonly>
</div>
    <br><br><br>    
   <a style="font-size:18px;">Date: <input type="date" style='border:none;text-align:center;' name='rgmdate' style="font-size:14px;" required></a><br>
    <a style="font-size:18px;">Reason: <input type="text"name='rgmreason' style=" border:0;outline: 0;background: transparent; border-bottom: 1px solid black;" required></a>
